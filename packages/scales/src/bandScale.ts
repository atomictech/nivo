...
import { ComputedSerieAxis, ScaleAxis, ScaleBand, ScaleBandSpec, StringValue } from './types'
...
export const castBandScale = <Input extends { toString(): string }>(scale: D3ScaleBand<Input>) => {
